...
export default function SaveConfirmDialog({ isOpen, onClose, onConfirm }: Props) {
      ...
      <div className="bg-white w-full max-w-sm rounded-2xl overflow-hidden shadow-xl flex flex-col animate-in zoom-in-95 duration-100 border border-slate-200">
        ...
        <div className="flex justify-end gap-2 px-5 py-4 bg-slate-50 border-t border-slate-100">
          ...
          <button
            ...
            type="button"
            className="flex items-center gap-1 px-4 py-2 bg-primary hover:bg-primary/95 text-white rounded-lg transition-colors text-xs font-bold cursor-pointer"
          >
            ยืนยันการบันทึก
          </button>
        </div>
